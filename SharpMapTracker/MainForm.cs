...
namespace SharpMapTracker
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            Text = "Erimyth MapTracker v" + Constants.MAP_TRACKER_VERSION;
        ...
        void MainForm_Load(object sender, EventArgs e)
        {
            ...
            map.Descriptions.Add("Created with Erimyth MapTracker v" + Constants.MAP_TRACKER_VERSION);
        ...
        private void trackOnlyCurrentFloorCheckBox_Click(object sender, EventArgs e)
        {

        }

        private void tileCountLabel_Click(object sender, EventArgs e)
        {
