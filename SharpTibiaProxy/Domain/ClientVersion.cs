...
namespace SharpTibiaProxy.Domain
{
    public class ClientVersion
    {
        ...
        public static readonly ClientVersion Version1098 = new ClientVersion { Number = 1098, FileVersion = "10.9.8.0", OtbmVersion = 2, OtbMajorVersion = 3, OtbMinorVersion = 57 };
        public static readonly ClientVersion Version1099 = new ClientVersion { Number = 1099, FileVersion = "10.9.8.0", OtbmVersion = 2, OtbMajorVersion = 3, OtbMinorVersion = 57 };
		public static readonly ClientVersion Version10000 = new ClientVersion { Number = 10000, FileVersion = "10.0.0.0", OtbmVersion = 2, OtbMajorVersion = 3, OtbMinorVersion = 57 }; //59
		public static readonly ClientVersion Current = Version10000;
        ...
        public static ClientVersion GetFromFileVersion(string fileVersion)
        {
            switch (fileVersion)
            {
				...
				case "10.9.9.0": return Version1099;
               case "10.0.0.0": return Version10000;
                default: return null;
            }
        }
